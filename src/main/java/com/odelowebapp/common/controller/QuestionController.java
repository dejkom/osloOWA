...
public class QuestionController implements Serializable {
    ...
    @EJB
    private com.odelowebapp.common.facade.QuestionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleQuestionnaire").getString("QuestionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleQuestionnaire").getString("QuestionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleQuestionnaire").getString("QuestionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
