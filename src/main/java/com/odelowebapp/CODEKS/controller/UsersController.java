...
public class UsersController implements Serializable {
    ...
    @EJB
    private com.odelowebapp.CODEKS.facade.UsersFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleCodeks").getString("UsersCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleCodeks").getString("UsersUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleCodeks").getString("UsersDeleted"));
        if (!JsfUtil.isValidationFailed()) {
