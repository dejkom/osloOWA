...
@Named
@ViewScoped
public class HRCourseIzvedbaIzobrazevanjaZaNazajBean implements Serializable {
    ...
    @PostConstruct
    public void init() {
        System.out.println("Sem v HRCourseIzvedbaIzobrazevanjaZaNazajBean");

        allOfferings = cofferingFacade.findAllCoursesInPast();
