...
public class FormAuthenticationFilter extends AuthenticatingFilter {
    ...
    public static final String DEFAULT_LOGIN_URL = "/faces/login.xhtml";
    ...
    public FormAuthenticationFilter() {
        System.out.println("SEM V KONSTRUKTORJU FormAuthenticationFilter Login URL:"+DEFAULT_LOGIN_URL);
        System.out.println("IS trace enabled?:"+log.isTraceEnabled());
    ...
    public void setLoginUrl(String loginUrl) {
        ...
        if (log.isTraceEnabled()) {
            System.out.println("Adding login url to applied paths.");
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        if (isLoginRequest(request, response)) {
            if (isLoginSubmission(request, response)) {
                ...
                System.out.println("Attempting to access a path which requires authentication.  Forwarding to the " + "Authentication url [" + getLoginUrl() + "]");
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        System.out.println("Sem v createToken()");
    ...
    protected boolean onLoginSuccess(AuthenticationToken token, Subject subject, ServletRequest request, ServletResponse response) throws Exception {
        System.out.println("-----Sem v onLoginSuccess()-----");
        System.out.println("token credentials:"+token.getCredentials().toString()+" principal:"+token.getPrincipal().toString()+" subjectprincipal:"+subject.getPrincipal().toString());
        System.out.println("Subject session id: "+subject.getSession().getId());
        
        //request.setAttribute("ADusername", token.getPrincipal().toString());
        subject.getSession().setAttribute("ADusername", token.getPrincipal().toString());
        
        System.out.println("-----Končal v onLoginSuccess()-----");
