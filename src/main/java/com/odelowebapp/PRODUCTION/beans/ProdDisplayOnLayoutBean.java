 ...
 * @author dematjasic
 */
@Named("prodDisplayOnLayoutBean")
@ViewScoped
public class ProdDisplayOnLayoutBean implements Serializable {
...
//            + "}";
    ...
    public void savingJSONComplete() {
        ...
        //Write JSON file
        try (FileWriter file = new FileWriter("Q:\\OEELayout.json")) {
    ...
    public void readJSONfile() {
        try {
            Path fileName = Path.of("Q:\\OEELayout.json");
