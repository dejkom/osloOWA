 ...
 * @author dematjasic
 */
@Named("prodDisplayOnLayoutPRSGBean")
@ViewScoped
public class ProdDisplayOnLayoutPRSGBean implements Serializable {
...
//            + "}";
    ...
    @PostConstruct
    public void init() {
        System.out.println("Sem v ProdDisplayOnLayoutPRSGBean init()");
    ...
    public void savingJSONComplete() {
        ...
        //Write JSON file
        try (FileWriter file = new FileWriter("Q:\\OEELayoutPRSG.json")) {
    ...
    public void readJSONfile() {
        try {
            Path fileName = Path.of("Q:\\OEELayoutPRSG.json");
